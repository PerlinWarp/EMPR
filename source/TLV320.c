...
void TLV320_Start_I2S_Polling_Passthrough(){
  uint8_t Data[18] = {0x1E,0x00,0x12,0x01,0x10,0x00,0x0E,0x02,0x0C,0x01,0x0A,0x01,0x08,0x14,0x00,0x17,0x02,0x17};//Reset, then
  TLV320_SendData(Data,18);}

void TLV320_SendData(uint8_t* Data,int length)
{
  I2C_M_SETUP_Type trData;
	SetupVals(&trData,TLV320_ADDR,Data,length);
