...
void TLV320_Start_I2S_Polling_Passthrough(){
  uint8_t Data[18] = {0x1E,0x00,0x12,0x01,0x10,0x00,0x0E,0x02,0x0C,0x01,0x0A,0x01,0x08,0x10,0x00,0x17,0x02,0x17};//Reset, then
                      //0x1E,0x00,0x01,0x17,0x10,0x00,0x0E,0x02,0x12,0x01
  TLV320_SendData(Data,18);}
void TLVTest(){
  uint8_t Data[6] = {0x1E,0x00,0x0E,0x42,0x12,0x01};//Enable DAC,Turn on Audio, enable i2s mode, change sample rate, activate interface
  TLV320_SendData(Data,6);}
